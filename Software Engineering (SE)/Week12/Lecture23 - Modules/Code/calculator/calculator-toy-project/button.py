...
Description:
This file contains a customised button widget implemented using Tkinter's `ttk.Button` class. 
...
initialise the widget with the specified attributes.
"""
