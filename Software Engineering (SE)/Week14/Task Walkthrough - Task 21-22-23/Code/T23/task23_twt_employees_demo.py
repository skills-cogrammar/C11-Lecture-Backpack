...
# - Change the salary of all employees with an id greater than 103 to 80000.
#
# ******************************************************
#   Import Libraries
# ******************************************************
...
try:
    ...
    # ===== Change the salary of all employees with an id
    # greater than 103 to a salary of 80000.
    cursor.execute('''UPDATE employees SET salary = ?
                      WHERE id > ? ''', (80000, 103))
    db.commit()
